import pytest
from qwen_self_planning_src_up2.rounded_avg import rounded_avg
...
def check(candidate):
    ...
    ret+=candidate(197,233) == "0b11010111"
    ret+=candidate(0, 0) == "0b0"
    ret+=candidate(-10, -1) == "0b-1100"
    ret+=candidate(2, 2) == "0b10"
    ret+=candidate(3, 5) == "0b110"
    ret+=candidate(4, 6) == "0b110"
    ret+=candidate(1, 10) == "0b1100"
    ret+=candidate(-5, 5) == "0b0"
    ret+=candidate(10, 10) == "0b1010"
    ret+=candidate(100, 200) == "0b11111010"
    ret+=candidate(1000, 2000) == "0b11111010000"
    ret+=candidate(1, 2) == "0b10"
    ret+=candidate(1, 3) == "0b10"
    ret+=candidate(1, 4) == "0b100"
    ret+=candidate(1, 5) == "0b101"
    ret+=candidate(1, 6) == "0b110"
    ret+=candidate(1, 7) == "0b110"
    ret+=candidate(1, 8) == "0b1000"
    ret+=candidate(1, 9) == "0b1001"
    ret+=candidate(1, 11) == "0b1011"
    ret+=candidate(1, 12) == "0b1100"
